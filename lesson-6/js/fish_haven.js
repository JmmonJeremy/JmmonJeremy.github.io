...
const apiURL = "https://api.openweathermap.org/data/2.5/weather?zip=83287,US&appid=d8504fb6db3692f9637d82ee139508e9&units=imperial";
fetch(apiURL)
...
const forecastURL = "https://api.openweathermap.org/data/2.5/forecast?zip=83287,US&appid=d8504fb6db3692f9637d82ee139508e9&units=imperial"
fetch(forecastURL)
    .then((response) => response.json())
    .then((jsObject) => {
      ...
      .then(function (jsonObject) {
        ...
        let cities = jsonObject["towns"];
          ...
          let townInfo = cities.filter(city => {
            return city.name.includes("Fish Haven")                
          });          
